...
## Tasks
1. Week 1: pull one year of Part B volumes for the seed codes and confirm the series exists.
2. Month 1: verify every code assignment and coverage date in `diagnostic_codes.csv`.
